...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options), IAppDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>(e =>
        {
            ...
            // Regra de negócio #5: além da validação no service, o banco garante
            // a unicidade — o teste de integração que insere duplicidade direto no
            // DB depende deste índice (o fake em memória não o verifica).
        ...
        modelBuilder.Entity<Order>(e =>
        {
            ...
            // Total é calculado, não mapeado no banco.
            e.Ignore(o => o.Total);
            // Mapeia a navegação para o backing field "_items".
